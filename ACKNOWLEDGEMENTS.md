...
* **[应急治理中自组织如何促进合作秩序生成？——基于大规模公众众包的分析](https://pattern.swarma.org/mobile/paper/531bd3c2-fc13-11ee-a95c-0242ac170005)**
  Pattern / Swarma: [Link](https://pattern.swarma.org/mobile/paper/531bd3c2-fc13-11ee-a95c-0242ac170005)
...
* **[应急管理中众包的理论内蕴与实践价值](https://dylc.cbpt.cnki.net/portal/journal/portal/client/paper/f44d9af6bf2a57871072a8f4bd8f59d3)**
  Journal Page: [Link](https://dylc.cbpt.cnki.net/portal/journal/portal/client/paper/f44d9af6bf2a57871072a8f4bd8f59d3)
...
* **[New Impetus and New Approaches](https://southsouth-galaxy.org/wp-content/uploads/2023/05/UNOSSC-Digital-Publication-14.pdf)**
  South-South Galaxy PDF: [Link](https://southsouth-galaxy.org/wp-content/uploads/2023/05/UNOSSC-Digital-Publication-14.pdf)
...
OpenRelief is informed by research in AI for disaster response, crisis computing, social media situation awareness, emergency message classification, rescue scheduling, crowdsourcing, and automated disaster reporting.

We acknowledge the following papers and lines of work that shaped this repository's architecture and AI workflow design:

## References and Related Work

- **[The Sphere Handbook: Humanitarian Charter and Minimum Standards in Humanitarian Response](https://spherestandards.org/wp-content/uploads/Handbook-2018-SimplifiedChinese-1.pdf)**  
  Authors: Sphere Association  
  Year: 2018  
  Venue: *The Sphere Handbook*, Fourth Edition  
  Stable URL: [Sphere Standards PDF](https://spherestandards.org/wp-content/uploads/Handbook-2018-SimplifiedChinese-1.pdf)  
  Notes: A core humanitarian standards reference covering the Humanitarian Charter, protection principles, and minimum standards in humanitarian response.

- **[GHTC Proceedings Published](https://ieeexplore.ieee.org/Xplore/home.jsp)**  
  Authors: IEEE Global Humanitarian Technology Conference community  
  Year: Ongoing  
  Venue: *IEEE Xplore / IEEE Global Humanitarian Technology Conference Proceedings*  
  Stable URL: [IEEE Xplore](https://ieeexplore.ieee.org/Xplore/home.jsp)  
  Notes: Collection of IEEE proceedings related to humanitarian technology, engineering for social good, disaster response, resilience, and technologies for underserved communities.

- **[Reports and Publications from the AI for Good community](https://aiforgood.itu.int/newsroom/publications-and-reports/)**  
  Authors: ITU AI for Good community  
  Year: Ongoing  
  Venue: *AI for Good / International Telecommunication Union*  
  Stable URL: [AI for Good Publications and Reports](https://aiforgood.itu.int/newsroom/publications-and-reports/)  
  Notes: Reports, whitepapers, and publications from the AI for Good community covering AI innovation, standards, global impact, and applications aligned with the Sustainable Development Goals.

- **[AIDR: Artificial Intelligence for Disaster Response](https://dl.acm.org/doi/abs/10.1145/2567948.2577034)**  
  Authors: Muhammad Imran; Carlos Castillo; Ji Lucas; Patrick Meier; Sarah Vieweg  
  Year: 2014  
  Venue: *WWW 2014 Companion - Proceedings of the 23rd International Conference on World Wide Web*, pp. 159–162   
  Stable URL: [ACM Digital Library](https://dl.acm.org/doi/abs/10.1145/2567948.2577034)  
  Notes: Introduces AIDR, a platform for classifying crisis-related microblog communications by combining machine learning and human participation for disaster response.
...
- **[CrisisSense-LLM: Instruction Fine-Tuned Large Language Model for Multi-label Social Media Text Classification in Disaster Informatics](https://arxiv.org/abs/2406.15477)**  
  Authors: Kai Yin; Bo Li; Chengkai Liu; Ali Mostafavi; Xia Hu  
  Year: 2024; revised 2025  
  Venue: *arXiv preprint*  
  Stable URL: [arXiv](https://arxiv.org/abs/2406.15477)  
  Notes: Presents an instruction fine-tuned large language model for multi-label classification of disaster-related social media text in crisis and disaster informatics.

- **[Using Social Media to Enhance Emergency Situation Awareness](https://www.ijcai.org/Proceedings/15/Papers/602.pdf)**  
  Authors: Jie Yin; Sarvnaz Karimi; Andrew Lampert; Mark Cameron; Bella Robinson; Robert Power  
  Year: 2015  
  Venue: *Proceedings of the Twenty-Fourth International Joint Conference on Artificial Intelligence (IJCAI 2015)*, pp. 4234–4239   
  Stable URL: [IJCAI PDF](https://www.ijcai.org/Proceedings/15/Papers/602.pdf)  
  Notes: Discusses how social media data can be processed to improve emergency situation awareness through filtering, classification, clustering, geotagging, and summarization.

- **[A Deep Learning Approach for Tweet Classification and Rescue Scheduling for Effective Disaster Management](https://dl.acm.org/doi/abs/10.1145/3347146.3359097)**  
  Authors: Md. Yasin Kabir; Sanjay Kumar Madria  
  Year: 2019  
  Venue: *Proceedings of the 27th ACM SIGSPATIAL International Conference on Advances in Geographic Information Systems*, pp. 269–278  
  Stable URL: [ACM Digital Library](https://dl.acm.org/doi/abs/10.1145/3347146.3359097)  
  Notes: Proposes a deep learning approach for disaster tweet classification and rescue scheduling using social media data from disaster events.

- **[Socially Enhanced Situation Awareness from Microblogs Using Artificial Intelligence: A Survey](https://dl.acm.org/doi/full/10.1145/3524498)**  
  Authors: Rabindra Lamsal; Aaron Harwood; Maria Rodriguez Read  
  Year: 2022  
  Venue: *ACM Computing Surveys*, Volume 55, Article 77, pp. 1–38  
  Stable URL: [ACM Digital Library](https://dl.acm.org/doi/full/10.1145/3524498)  
  Notes: Surveys artificial intelligence methods for extracting situation awareness from microblog data across domains including disasters, health, politics, finance, and the physical environment.

- **[Harnessing prompt-based large language models for disaster monitoring and automated reporting from social media feedback](https://www.sciencedirect.com/science/article/pii/S246869642400020X)**  
  Authors: Riccardo Cantini; Cristian Cosentino; Fabrizio Marozzo; Domenico Talia; Paolo Trunfio  
  Year: 2025  
  Venue: *Online Social Networks and Media*, Volume 45, Article 100295  
  Stable URL: [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S246869642400020X)  
  Notes: Examines prompt-based large language models for disaster monitoring and automated reporting from social media feedback.

- **[Intelligent Disaster Response via Social Media Analysis: A Survey](https://dl.acm.org/doi/abs/10.1145/3137597.3137602)**  
  Authors: Tahora H. Nazer; Guoliang Xue; Yusheng Ji; Huan Liu  
  Year: 2017  
  Venue: *ACM SIGKDD Explorations Newsletter*, Volume 19, Issue 1, pp. 46–59  
  Stable URL: [ACM Digital Library](https://dl.acm.org/doi/abs/10.1145/3137597.3137602)  
  Notes: Surveys intelligent disaster response approaches using social media analysis, including emergency detection, information extraction, and disaster relief coordination.

- **[Using artificial intelligence to identify emergency messages on social media during a natural disaster: A deep learning approach](https://www.sciencedirect.com/science/article/pii/S2667096823000113)**  
  Authors: Courtney J. Powers; Ashwin Devaraj; Kaab Ashqeen; Aman Dontula; Amit Joshi; Jayanth Shenoy; Dhiraj Murthy  
  Year: 2023  
  Venue: *International Journal of Information Management Data Insights*, Volume 3, Issue 1, Article 100164  
  Stable URL: [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S2667096823000113)  
  Notes: Uses a deep learning approach to identify emergency messages on social media during natural disasters.

These works inform OpenRelief's emphasis on:

- human-in-the-loop classification and review;
- multi-label disaster information structuring;
- relevance and urgency triage;
- recall-first evaluation for life-safety signals;
- topic, trend, and location-aware situation awareness;
- source-grounded report drafting;
- privacy, safety, provenance, and auditability;
- digital volunteer collaboration.
