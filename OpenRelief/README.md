...
OpenRelief is an open-source humanitarian relief coordination project for NGOs, volunteer networks, and community responders. It builds on the field experience of NCP Life Support and the disaster information service methodology inherited from Zhuoming Disaster Information Service Center, with the goal of using AI to improve disaster information processing, needs triage, resource matching, and collaborative response.
